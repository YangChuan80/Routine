...
for sheetname in sheet:
   dict_filtered[sheetname]=dict_merged[sheetname][['m/z','Intens.']]
               # columns=['m/z','Intens.'])

df=concat([dict_filtered[sheetname] for sheetname in sheet],axis=0,keys=sheet)

df.to_csv('D:\\Database\\Export Intensity.csv')
